...
-- -----------------------------------------------------
-- Table `gestion_vuelos`.`tipos_de_documentos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestion_vuelos`.`tipos_de_documentos` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `pais` BIGINT(20) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tipos_de_documentos_paises1_idx` (`pais` ASC) VISIBLE,
  CONSTRAINT `fk_tipos_de_documentos_paises1`
    FOREIGN KEY (`pais`)
    REFERENCES `gestion_vuelos`.`paises` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `gestion_vuelos`.`usuarios` (
  ...
  `actualizado` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP(),
  `estado` TINYINT(1) NOT NULL DEFAULT 1,
  `tipos_de_documentos_id` BIGINT(20) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_usuarios_tipos_de_documentos1_idx` (`tipos_de_documentos_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_usuarios_aerolineas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuarios_tipos_de_documentos1`
    FOREIGN KEY (`tipos_de_documentos_id`)
    REFERENCES `gestion_vuelos`.`tipos_de_documentos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
